-- Config default resmi dari Hyprland, disalin apa adanya dari
-- https://github.com/hyprwm/Hyprland/blob/main/example/hyprland.lua
-- (per wiki: https://wiki.hypr.land/Configuring/Start/)
--
-- Overrides/keybind tambahan buat integrasi Noctalia ada di
-- ../noctalia/noctalia.lua (di-import SETELAH file ini lewat
-- home/rizz404/default.nix, jadi dia yang menang kalau ada key yang sama).
